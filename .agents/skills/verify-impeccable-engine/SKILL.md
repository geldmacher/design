...
description: Validate changes to the pinned Impeccable engine, Design detector, host adapters, free Motion integration, or plugin packages in this source repository. Runs isolated integration tests; excludes application UI reviews and live editor activation.
---

# Verify Impeccable engine

Run from the Design source repository with Node.js 22+, Git, zip, unzip and installed project dependencies. Read the [feature index](features/README.md) for coverage and expected observations.
