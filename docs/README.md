...
These guides are for working on the plugin itself. You do not need them to use it in a website or web-app project.

| Task | Guide |
| --- | --- |
| Change the source, run checks, or deploy a development copy | [Development](development.md) |
...
Repository checks, installation, behavior in a fresh editor task, and publication each need their own evidence. The maintainer guides explain what each check establishes.
